...
namespace Noot.DataAccess.Models
{
    ...
    [Table("OrganizationStructureEAV", Schema = "com")]
    public partial class OrganizationStructureEAV
    {
        public OrganizationStructureEAV()
        {
        }
        [Key]
        ...
        public virtual OrganizationStructure Element { get; set; }
